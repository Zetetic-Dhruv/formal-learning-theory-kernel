...
which contains 354 machine-checked theorems in 21{,}522 lines with zero
\texttt{sorry}, and a companion textbook on formal learning theory from
which most of the exposition in Chapters~\ref{chap:pac}
through~\ref{chap:separations} is imported directly. The blueprint's
...
\begin{itemize}[leftmargin=*,itemsep=3pt]
  \item \textbf{PAC characterization} (Chapter~\ref{chap:pac}): the
  ...
  \item \textbf{Online characterization} (Chapter~\ref{chap:online}):
    the Littlestone characterization theorem with the Standard Optimal
    Algorithm as the constructive witness.
  \item \textbf{Gold-style learning} (Chapter~\ref{chap:gold}): Gold's
  ...
  \item \textbf{Three-paradigm separation}
    (Chapter~\ref{chap:separations}): the 13-edge separation lattice
...
Chapters~\ref{chap:primitives} through \ref{chap:separations} of this
