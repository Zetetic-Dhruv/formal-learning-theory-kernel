...
% In the print build, \lean renders the identifier as visible monospace text
% so the reader can locate the corresponding Lean declaration.
\providecommand{\lean}[1]{\par\noindent\texttt{\small Lean: #1}\par}
