...
% In the print build, \lean renders as a small identifier on its own line,
% separated from the theorem text that follows.
...
\lstdefinelanguage{Lean4}{
  morekeywords={def,theorem,lemma,structure,class,instance,abbrev,
    ...
    induction,unfold,rw,ext,push_neg,exfalso,absurd,calc,fun,if,
    then,else,match,with,do,return,sorry,import,open,variable,
    section,namespace,end,set_option,universe,Type,Prop,Sort,
    Finset,Set,Nat,Bool,true,false,Fin,List,WithTop,WithBot,
    Measure,MeasurableSpace,MeasurableSet,NullMeasurableSet},
  sensitive=true,
  morecomment=[l]{--},
  morecomment=[n]{/-}{-/},
  morestring=[b]",
