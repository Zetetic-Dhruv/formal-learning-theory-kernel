...
The default Lake target is `FLT_Proofs` (all 37 files). It **does** permit `sorry` (Lean's default). The CI workflow enforces the sorry ceiling independently.

## File Inventory

All counts generated by `scripts/metrics.sh`:

- 37 `.lean` files in `FLT_Proofs/`
- 17,350 lines of Lean4
- 264 theorem/lemma statements (173 public, 91 private)
- 190 definitions
- 52 structures
- 2 sorry tactics
