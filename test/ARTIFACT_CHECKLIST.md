...
The default Lake target is `FLT_Proofs` (all 47 files). A second target `WorldModel` builds the proof operad (8 files). Both permit `sorry` (Lean's default). The CI workflow enforces the sorry ceiling independently.

## File Inventory

All counts generated by `scripts/metrics.sh`:

- 47 `.lean` files in `FLT_Proofs/`
- 18,356 lines of Lean4
- 292 theorem/lemma statements (204 public, 88 private)
- 212 definitions
- 56 structures
- 2 sorry tactics
