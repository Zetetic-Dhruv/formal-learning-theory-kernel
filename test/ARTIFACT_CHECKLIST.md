...
The default Lake target is `FLT_Proofs` (all 43 files). A second target `WorldModel` builds the proof operad (8 files). Both permit `sorry` (Lean's default). The CI workflow enforces the sorry ceiling independently.

## File Inventory

All counts generated by `scripts/metrics.sh`:

- 43 `.lean` files in `FLT_Proofs/`
- 17,956 lines of Lean4
- 278 theorem/lemma statements (190 public, 88 private)
- 200 definitions
- 54 structures
- 2 sorry tactics
